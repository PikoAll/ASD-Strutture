...
/*
    ...
    cout<<"oraa "<<Tree.zeroNodi(Tree.binRadice());
system("pause");
   ...
   system("pause");*/
    ...
    BinAlbero<int> a;
    typename BinAlbero<int>::Nodo radice,nodo,nodo1;
    radice=new Cella<int>;
    a.insBinRadice(radice);
    a.scriviNodo(a.binRadice(),1);


    a.insFiglioSinistro(a.binRadice());
    a.insFiglioDestro(a.binRadice());

    a.scriviNodo(a.figlioSinistro(a.binRadice()),2);
    a.scriviNodo(a.figlioDestro(a.binRadice()),3);

    nodo=a.figlioSinistro(a.binRadice());
    nodo1=a.figlioDestro(a.binRadice());

    a.insFiglioDestro(nodo);
    a.insFiglioSinistro(nodo);

    a.scriviNodo(a.figlioSinistro(nodo),4);
    a.scriviNodo(a.figlioDestro(nodo),5);

    nodo=a.figlioSinistro(nodo);

   a.insFiglioSinistro(nodo1);

    a.insFiglioDestro(nodo1);

    a.scriviNodo(a.figlioSinistro(nodo1),6);
    a.scriviNodo(a.figlioDestro(nodo1),7);

    a.insFiglioSinistro(nodo);
    a.insFiglioDestro(nodo);
    a.scriviNodo(a.figlioSinistro(nodo),8);
    a.scriviNodo(a.figlioDestro(nodo),9);

    nodo=a.figlioSinistro(nodo);
    a.insFiglioSinistro(nodo);

    a.scriviNodo(a.figlioSinistro(nodo),10);


    a.stampa();
    cout<<endl;

 //  a.modificaConNumeroPariFigli(a);
   cout<<"mhaa"<<endl;
    a.stampa();
  //  cout<<endl<<"numero nodi livello k: "<<endl;
   // cout<<a.numeroNodiDiLivelloK(a,4);

  //  cout<<a.nFogliePari(a);

    //cout<<a.d3(a,3);

  //  cout<<a.l2p(a);
    a.mediaNodi(a.binRadice());
